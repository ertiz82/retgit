...
|--------|------|--------|---------------|
| Laravel | Framework | ✅ Available | [laravel.md](plugins/laravel.md) |
| Version | Release Management | ✅ Available | [version.md](plugins/version.md) |
| Changelog | Release Management | ✅ Available | [changelog.md](plugins/changelog.md) |
...
- **[Laravel Plugin](plugins/laravel.md)** - Intelligent Laravel file grouping, version detection, framework file identification

### Release Management Plugins

- **[Version Plugin](plugins/version.md)** - Semantic versioning, auto file updates, git tagging
- **[Changelog Plugin](plugins/changelog.md)** - Automatic changelog generation from commits
